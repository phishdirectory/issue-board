    ...
    <div className="min-h-screen bg-[#f5f3f0] flex flex-col">
      ...
      <main className="flex-grow container mx-auto py-8 px-4">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2 text-[#55625c]">GitHub Issue Beacon</h1>
          <p className="text-[#55625c] max-w-2xl mx-auto">
            Displaying issues from the "phish-directory" organization tagged with 
            the "issue-board" label.
          </p>
        </div>
      ...
      <footer className="bg-[#55625c] text-white p-4 text-center text-sm">
